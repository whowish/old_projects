 		...
 		loading_button: function(enabled,options) {
    		...
    		return this.each(function() {
				...
				if (enabled == true)
				{
					...
					$(this).html('<span style="display:inline-block;" onclick="if (event.stopPropagation) event.stopPropagation();event.cancelBubble = true;">'+options.image + ' ' + options.word+'</span>');
