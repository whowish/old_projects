		...
		loading_icon:function(enabled)
		{
			return this.each(function() {
				...
				if (enabled == true)
				{
					...
					$(this).html('<span style="display:inline-block;width:100%;height:100%;" onclick="if (event.stopPropagation) event.stopPropagation();event.cancelBubble = true;return false;"><img src="/images/button_loader.gif" style="margin-top:4px;"/></span>');
				}
				else
				{
