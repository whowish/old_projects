class DisagreeMemberAction < MemberAction
  ...
  def self.perform(entity_class_name, related_entity_id, member_id)
    ...
    cancel_action(AgreeMemberAction, entity_class_name, related_entity_id, member_id)
    add_action(DisagreeMemberAction, entity_class_name, related_entity_id, member_id)
